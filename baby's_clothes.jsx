    ...
    <div style={{backgroundColor:"rgba(255, 75, 240, 0.986)",marginRight:"-100px",marginLeft:"-110px"}}>
        ...
        <button onClick={this.delete} style={{borderColor:"",marginLeft:"800px",marginTop:"-100px",position:"fixed",backgroundColor:"rgba(247, 21, 255, 0.699)"}}>
         ...
         <div style={{display:"inline-block",width:"800px",marginLeft:"55px"}}> 
            <img  class="im" src="a1.jpg" style={{height:"240px",width:"220px",borderRadius:"20px",marginLeft:"-10px"}}></img>
            ...
            <img class="im" src="a2.jpg" style={{height:"240px",width:"220px",borderRadius:"20px",marginLeft:"10px",marginTop:"10px"}}></img>
            <button class="b" onClick={this.onClick} style={{paddingLeft:"70px",paddingRight:"100px",backgroundColor:"rgb(170, 221, 255)",backgroundImage:"cart.PNG",backgroundImage:"url(cart.PNG)",backgroundSize:"55px",backgroundRepeat:"no-repeat",height:"50px",width:"40px",marginLeft:"5px",borderRadius:"10px"}}>20.90$</button>
             </div>
            <div style={{display:"inline-block",width:"800px",marginLeft:"55px"}}> 
            <img class="im" src="a3.jpg" style={{height:"240px",width:"220px",borderRadius:"20px",marginLeft:"-10px"}}></img>
            <button class="b" onClick={this.onClick} style={{paddingLeft:"70px",paddingRight:"100px",backgroundColor:"rgb(170, 221, 255)",backgroundImage:"cart.PNG",backgroundImage:"url(cart.PNG)",backgroundSize:"55px",backgroundRepeat:"no-repeat",height:"50px",width:"40px",marginLeft:"5px",borderRadius:"10px"}}>30.99$</button>
            
            <img class="im" src="a4.jpg" style={{height:"240px",width:"220px",borderRadius:"20px",marginLeft:"10px",marginTop:"10px"}}></img>
            ...
            <div style={{display:"inline-block",width:"800px",marginLeft:"55px"}}> 
            <img class="im" src="a5.jpg" style={{height:"240px",width:"220px",borderRadius:"20px",marginLeft:"-10px"}}></img>
            ...
            <img class="im" src="m22.jpg" style={{height:"240px",width:"220px",borderRadius:"20px",marginLeft:"10px",marginTop:"10px"}}></img>
            ...
            <div style={{display:"inline-block",width:"800px",marginLeft:"55px"}}> 
            <img class="im" src="a7.jpg" style={{height:"240px",width:"220px",borderRadius:"20px",marginLeft:"-10px"}}></img>
            <button class="b" onClick={this.onClick} style={{paddingLeft:"70px",paddingRight:"100px",backgroundColor:"rgb(170, 221, 255)",backgroundImage:"cart.PNG",backgroundImage:"url(cart.PNG)",backgroundSize:"55px",backgroundRepeat:"no-repeat",height:"50px",width:"40px",marginLeft:"5px",borderRadius:"10px"}}>40.90$</button>
            
            <img class="im" src="a8.jpg" style={{height:"240px",width:"220px",borderRadius:"20px",marginLeft:"10px",marginTop:"10px"}}></img>
            <button class="b" onClick={this.onClick} style={{paddingLeft:"70px",paddingRight:"100px",backgroundColor:"rgb(170, 221, 255)",backgroundImage:"cart.PNG",backgroundImage:"url(cart.PNG)",backgroundSize:"55px",backgroundRepeat:"no-repeat",height:"50px",width:"40px",marginLeft:"5px",borderRadius:"10px"}}>40.99$</button>
            </div>
            <div style={{display:"inline-block",width:"800px",marginLeft:"55px"}}> 
            <img class="im" src="a9.jpg" style={{height:"240px",width:"220px",borderRadius:"20px",marginLeft:"-10px"}}></img>
            <button class="b" onClick={this.onClick} style={{paddingLeft:"70px",paddingRight:"100px",backgroundColor:"rgb(170, 221, 255)",backgroundImage:"cart.PNG",backgroundImage:"url(cart.PNG)",backgroundSize:"55px",backgroundRepeat:"no-repeat",height:"50px",width:"40px",marginLeft:"5px",borderRadius:"10px"}}>45.99$</button>
            
            <img class="im" src="a10.jpg" style={{height:"240px",width:"220px",borderRadius:"20px",marginLeft:"10px",marginTop:"10px"}}></img>
            ...
            <div style={{display:"inline-block",width:"800px",marginLeft:"55px"}}> 
            <img class="im" src="a11.jpg" style={{height:"240px",width:"220px",borderRadius:"20px",marginLeft:"-10px"}}></img>
            ...
            <img class="im" src="m21.jpg" style={{height:"240px",width:"220px",borderRadius:"20px",marginLeft:"10px",marginTop:"10px"}}></img>
            <button class="b" onClick={this.onClick} style={{paddingLeft:"70px",paddingRight:"100px",backgroundColor:"rgb(170, 221, 255)",backgroundImage:"cart.PNG",backgroundImage:"url(cart.PNG)",backgroundSize:"55px",backgroundRepeat:"no-repeat",height:"50px",width:"40px",marginLeft:"5px",borderRadius:"10px"}}>38.99$</button>
            </div>
            <div style={{display:"inline-block",width:"800px",marginLeft:"55px"}}> 
            <img class="im" src="a13.jpg" style={{height:"240px",width:"220px",borderRadius:"20px",marginLeft:"-10px"}}></img>
            <button class="b" onClick={this.onClick} style={{paddingLeft:"70px",paddingRight:"100px",backgroundColor:"rgb(170, 221, 255)",backgroundImage:"cart.PNG",backgroundImage:"url(cart.PNG)",backgroundSize:"55px",backgroundRepeat:"no-repeat",height:"50px",width:"40px",marginLeft:"5px",borderRadius:"10px"}}>33.99$</button>
            
            <img class="im" src="a14.jpg" style={{height:"240px",width:"220px",borderRadius:"20px",marginLeft:"10px",marginTop:"10px"}}></img>
            ...
            <div style={{display:"inline-block",width:"800px",marginLeft:"55px"}}> 
            <img class="im" src="a15.jpg" style={{height:"240px",width:"220px",borderRadius:"20px",marginLeft:"-10px"}}></img>
            ...
            <img class="im" src="a17.jpg" style={{height:"240px",width:"220px",borderRadius:"20px",marginLeft:"10px",marginTop:"10px"}}></img>
            <button class="b" onClick={this.onClick} style={{paddingLeft:"70px",paddingRight:"100px",backgroundColor:"rgb(170, 221, 255)",backgroundImage:"cart.PNG",backgroundImage:"url(cart.PNG)",backgroundSize:"55px",backgroundRepeat:"no-repeat",height:"50px",width:"40px",marginLeft:"5px",borderRadius:"10px"}}>29.90$</button>
            </div>
